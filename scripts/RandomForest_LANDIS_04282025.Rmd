...
train_model <- function(df, species, response="ag_carbon") {
  ...
  rf_grid <- expand.grid(mtry = seq(5, 20, 5), trees = seq(100,800,400), min_n = seq(1, 9, 3))
  ...
  mdsplot <- ggplot(mds_df, aes(x = Dim1, y = Dim2, color = ag_carbon)) +
...
write.csv(proximity_data, "data/analysis/MDS_Data_LANDIS.csv", row.names = FALSE)
